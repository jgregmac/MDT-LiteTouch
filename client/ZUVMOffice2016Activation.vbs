...
If CSI_IsAdmin Then
	...
	path64os32office = "C:\Program Files (x86)\Microsoft Office\Office16\"
	path32os32office = "C:\Program Files\Microsoft Office\Office16\"
	...
	Else
		...
		objShell.Run "cscript " + """" + folder  + "\""" +  "OSPP.VBS" + " /inpkey:KGVJ4-HH4GG-WYTQG-6DPTR-Q8W2V", 1, true 
